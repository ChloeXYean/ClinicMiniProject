...
namespace ClinicMiniProject
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddTransient<ActiveConsultationPage>();
            builder.Services.AddTransient<ActiveConsultationViewModel>();
            ...
            builder.Services.AddTransient<AppointmentCancellationPage>();
            builder.Services.AddTransient<AppointmentCancellationViewModel>();
